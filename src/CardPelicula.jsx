  ...
  return (
    ...
    <Card.Root width="9vw" margin="1vw" height="40hv">
      ...
      <Card.Body padding="10px">
        <Card.Title textAlign="left" marginTop="15px" textWrap="nowrap" overflow="hidden" className="tituloTarjeta"><Link to={"/info/movie/"+props.id}>{props.title}</Link></Card.Title>
